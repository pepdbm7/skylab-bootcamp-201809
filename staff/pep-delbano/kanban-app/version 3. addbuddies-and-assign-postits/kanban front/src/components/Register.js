...
class Register extends Component {
    state = { registerMessage:"", name: '', surname: '', username: '', password: '' }
    ...
    handleSubmit = event => {
        ...
        .then(()=> {
            ...
            try {
                this.setState({ registerMessage: "User registered correctly", name: '', surname: '', username: '', password: '' }, () => {
                    setTimeout(() => {
    ...
    render() {
        return <div className="container-register">
            ...
            <form className="form-group form-register" onSubmit={this.handleSubmit}>
                ...
                <p className="error">{this.state.registerMessage}</p>
            </form>
        </div>
    }
}
